    ...
    return(
      ...
      <View style={styles.container}>  
        ...
        <View style={styles.container_form_login}>
            ...
            <TouchableOpacity style={[styles.btn,styles.btn__primary,styles.margin_top_20]}>
                <Text style={styles.btn__primaryText}>SIGN IN</Text>   
            </TouchableOpacity>
            <TouchableOpacity style={[styles.btn,styles.btn__second, styles.margin_top_20]}>
                <Text style={styles.btn__primaryText2}>SIGN UP</Text>
            </TouchableOpacity>
        </View>
      </View>
    )
